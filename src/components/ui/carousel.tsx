...
interface CarouselContentProps extends 
...
>(({ className, parentClassName, ...props }, ref) => {
  ...
  return (
    <div ref={carouselRef} className={cn("overflow-hidden", parentClassName)}>
      <div
        ref={ref}
        className={cn(
          "flex",
...
>(({ className, arrowClassName, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ChevronLeft className={cn("h-8 w-8", arrowClassName)} />
...
>(({ className, arrowClassName, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ChevronRight className={cn("h-8 w-8", arrowClassName)} />
